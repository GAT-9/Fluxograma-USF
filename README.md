...
1. Mapear e representar fluxos assistenciais da APS

1. Padronizar processos de atendimento nas USF

1. Apoiar a implementação de protocolos clínicos

1. Facilitar a visualização de fluxos por profissionais de saúde

1. Contribuir para a transformação digital no SUS

## 🏥 Contexto de Aplicação

**O sistema é voltado para:**

- *Unidades de Saúde da Família (USF)*<br>
- *Equipes de Atenção Primária*<br>
- *Gestores municipais de saúde*<br>
- *Projetos de educação permanente em saúde*<br>
...
- 🔄 Edição e atualização de fluxos<br>
- 👀 Visualização estruturada de processos<br>
